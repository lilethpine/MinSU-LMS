                ...
                <div class="col-12 p-card">
                  <div class="row">
                    <div class="col-sm-12 col-md-12">
                      <div class="row">
                        <div class="col-lg-8">
                              <h6 class="mt-3 mt-sm-0">Date Posted: <?php echo date('l, M d, Y h:i A', strtotime($activity['date_posted'])); ?></strong></h6><br>
                              <h5 class="mt-3 mt-sm-0"><strong><?php echo $activity['act_title']; ?></strong></h5>
