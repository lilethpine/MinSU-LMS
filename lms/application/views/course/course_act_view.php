                ...
                <div class="col-12 p-card">
                  <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                      <div class="row">
                        <div class="col-lg-8">
                              <h5 class="mt-3 mt-sm-0"><strong><?php echo $act['act_title']; ?></strong></h5><br>
                              <p class="fs--1 mb-2 mb-md-3"><?php echo $act['act_desc']; ?></p>
                              <h6 class="mb-0"><a href="<?php echo BASE_URL.'/public/uploads/activity/'.$act['act_attachments']; ?>" target="_blank"><?php echo $act['act_attachments']; ?> </a></h6>
                        </div>
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                              <form method="POST" action="<?php echo site_url('student/submit_act'); ?>" enctype="multipart/form-data">
                                    <div class="d-none d-lg-block">
                                          <h6><strong>Due Date: <?php echo date('M d, Y h:i A', strtotime($act['due_date'])); ?></strong></h6>
                                          <div class="border-dashed-bottom my-3"></div>
                                          <h5 class="mt-3 mt-sm-0">Add Attachments</h5>
                                    </div>
                                    <div class="mt-2">
                                          <input class="form-control " type="file" name="attachments" required>
                                          <button class="btn btn-sm btn-primary d-lg-block mt-lg-2 px-7" type="submit"><span class="fas fa-plus me-2"></span>Submit</button>
                                    </div>
                              </form>
                        </div>
                      </div>
